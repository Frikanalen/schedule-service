...
from schema.tva.metadata.pkg_2019.delivery_mode_type import DeliveryModeType
...
@dataclass
class OnDemandProgramType(ProgramLocationType):
    ...
    first_availability: Optional[FlagType] = field(
        default=None,
        metadata={
            "name": "FirstAvailability",
            "type": "Element",
            "namespace": "urn:tva:metadata:2019",
        },
    )
    last_availability: Optional[FlagType] = field(
        default=None,
        metadata={
    ...
    immediate_viewing: Optional[FlagType] = field(
        default=None,
        metadata={
            "name": "ImmediateViewing",
            "type": "Element",
            "namespace": "urn:tva:metadata:2019",
        },
    )
    delivery_mode: Optional[DeliveryModeType] = field(
        default=None,
        metadata={
            "name": "DeliveryMode",
            "type": "Element",
    ...
    early_playout: Optional[FlagType] = field(
        default=None,
        metadata={
            "name": "EarlyPlayout",
            "type": "Element",
    ...
    expiry_time_after_firs_start: Optional[XmlDuration] = field(
        default=None,
        metadata={
            "name": "ExpiryTimeAfterFirsStart",
            "type": "Element",
            "namespace": "urn:tva:metadata:2019",
        },
    )
    embargo_time: Optional[XmlDateTime] = field(
        default=None,
        metadata={
            "name": "EmbargoTime",
            "type": "Element",
    ...
    max_number_of_downloads: Optional[int] = field(
        default=None,
        metadata={
    ...
    expiry_time_after_download: Optional[XmlDuration] = field(
        default=None,
        metadata={
            "name": "ExpiryTimeAfterDownload",
            "type": "Element",
            "namespace": "urn:tva:metadata:2019",
        },
    )
    expiry_time_after_download_first_start: Optional[XmlDuration] = field(
        default=None,
        metadata={
            "name": "ExpiryTimeAfterDownloadFirstStart",
            "type": "Element",
            "namespace": "urn:tva:metadata:2019",
        },
    )
